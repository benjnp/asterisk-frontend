...
import { Multicall2 } from '@/config/abi/types/Multicall';
import { useActiveWeb3React } from '@/hooks/useActiveWeb3React';
import { useCurrentBlock } from '@/hooks/useBlock';
...
): Promise<{ results: Multicall2.ResultStructOutput[]; blockNumber: number }> {
